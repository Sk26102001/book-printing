...
//             </div>
//             <div className="text-center">
//               <p className="text-white/60 text-xs">GST (18%)</p>
...
//       icon: BookOpen,
//       title: 'Book Printing',
//       desc: 'Professional book printing with multiple binding options. Perfect for novels, textbooks, manuals.',
//       color: 'text-primary',
//       bg: 'bg-primary/10',
//     },
//     {
...
//               <div
//                 className="inline-flex items-center gap-2 bg-primary/20 text-primary border border-primary/30 rounded-full px-4 py-2 text-sm font-medium animate-slide-up"
//               >
//                 <Star className="h-4 w-4" />
//                 Delhi's Most Trusted Printing Partner
//               </div>
...
//               {/* Trust badges */}
//               <div className="animate-fade-in flex flex-wrap items-center gap-4 pt-4" style={{ animationDelay: '0.5s' }}>
...
//                   ))}
//                 </div>
//                 <div className="absolute -bottom-4 -right-4 bg-primary rounded-full p-4 shadow-xl animate-pulse">
      ...
      <section className="relative bg-secondary min-h-screen flex items-center overflow-hidden pt-16">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            {/* Left Content */}
            <div className="space-y-8">
              <div className="inline-flex items-center gap-2 bg-primary/20 text-primary border border-primary/30 rounded-full px-4 py-2 text-sm font-medium animate-slide-up">
                <Star className="h-4 w-4" />
                Delhi's Most Trusted Printing Partner
              </div>
              <h1 className="animate-slide-up text-4xl sm:text-5xl lg:text-6xl font-black text-white leading-tight" style={{ animationDelay: '0.1s' }}>
            ...
            {/* Right — Printing Press Image */}
            <div className="hidden lg:block relative animate-float">
             <img
  src="/img1.jpeg"
  alt="Modern digital printing press in production"
  className="w-[700px] h-[300px] mx-auto rounded-2xl shadow-2xl object-cover border-8 border-white/10"
/>
